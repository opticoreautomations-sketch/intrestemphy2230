  ...
  return (
    <div className="min-h-screen flex items-center justify-center physics-bg overflow-hidden relative">
      ...
      <motion.div 
        ...
        className="glass-card p-12 text-center max-w-xl w-full relative z-10 shadow-2xl border-primary/20"
      >
        <motion.div
          animate={{ y: [0, -10, 0] }}
          transition={{ duration: 2, repeat: Infinity }}
          className="mx-auto bg-primary/20 w-24 h-24 rounded-3xl flex items-center justify-center mb-8 shadow-inner"
        >
